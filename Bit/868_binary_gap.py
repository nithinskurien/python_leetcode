...
#
# Logic:
# We can get the last bit (LSB) and if it is one we can keep track of it's position and then subtract the last position
# of one with the current position and keep checking if it is max.
