...
#
# Logic:
# We sort the array and make one pass to find the smallest difference. We can then make a second pass to add to the
# result the list of pairs that make that difference.
