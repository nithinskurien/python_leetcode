...
#
# each s[i] maps to exactly one t[i]
#
# no two s characters map to the same t
# So we can get the length of the zip set, and each individual sets and all of them should be equal
