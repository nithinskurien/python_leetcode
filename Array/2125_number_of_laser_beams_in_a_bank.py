...
#
# Logic:
# We can initialise the result, prev and curr variables to keep track of the total beams, prev devices and curr devices.
# We will go through all the rows and then keep track of the curr devices and the prev devices (where the row had some
# devices). We can then add the product of prev * curr to the res every time curr is not zero.
